...
def main(sleep_ms=0, fail_rate=0):
    ...
    """
    print("INIT JOB SCAN")
    print(f"Starting Task #{TASK_INDEX}, Attempt #{TASK_ATTEMPT}...#{TASK_ID}")
    ...
    try:
        if TASK_INDEX == 0:
            ...
            print("Task 1")
            # Convertir milisegundos a segundos y dormir
            time.sleep(sleep_ms / 1000.0)
            # Simular fallo basado en la tasa de fallos
            random_failure(rate=fail_rate)
